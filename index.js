...
var li = document.getElementsByClassName('bearname')
console.log(li);
...
img.src = "http://placecorgi.com/300/500"

// Lets change the class of the lis to be "corgitype"

document.querySelectorAll('li').forEach(function (l) {
  l.className = "corgitype"
})

ul[0].innnerText = "Pembroke"
console.log(li);
